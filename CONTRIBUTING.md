...
- The best way to report a bug is to create a failing com.zongze.test case. Please see the [Contributing code](CONTRIBUTING.md#contributing-code) section.
...
For how to write a unit com.zongze.test, please see the [unit com.zongze.test](https://github.com/mybatis/mybatis-3/wiki/Unit-Test) page.
