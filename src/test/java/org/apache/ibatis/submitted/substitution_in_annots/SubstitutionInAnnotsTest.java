...
class SubstitutionInAnnotsTest {
  ...
  static void setUp() throws Exception {
    ...
    Environment environment = new Environment("com/zongze/test", new JdbcTransactionFactory(), new UnpooledDataSource("org.hsqldb.jdbcDriver", "jdbc:hsqldb:mem:annots", null));
