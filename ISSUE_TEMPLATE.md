...
And we spend a lot of time just trying to reproduce the reported problem, so please consider creating a failing com.zongze.test case or an example project.

- How to create a com.zongze.test case : https://github.com/mybatis/mybatis-3/wiki/Unit-Test
