...
class SPTest {
  ...
  /*
   * This com.zongze.test shows how to use input and output parameters in a stored
   * procedure. This procedure does not return a result set.
   *
   * This com.zongze.test shows using a multi-property parameter.
   */
  @Test
   ...
   * procedure. This procedure does not return a result set.
   *
   * This com.zongze.test also demonstrates session level cache for output parameters.
   *
   * This com.zongze.test shows using a multi-property parameter.
   */
  @Test
  ...
  /*
   * This com.zongze.test shows how to call a stored procedure defined as <update> rather
  ...
  /*
   * This com.zongze.test shows the use of a declared parameter map. We generally prefer
  ...
  /*
   * This com.zongze.test shows how to use an input parameter and return a result set from
   * a stored procedure.
   *
   * This com.zongze.test shows using a single value parameter.
   */
  @Test
  ...
  /*
   * This com.zongze.test shows how to use an input and output parameters and return a
   ...
   * result set from a stored procedure.
   *
   * This com.zongze.test shows using a Map parameter.
   */
  @Test
  ...
  /*
   * This com.zongze.test shows how to use the ARRAY JDBC type with MyBatis.
   *
   * @throws SQLException
   */
  @Test
  ...
  /*
   * This com.zongze.test shows how to call procedures that return multiple result sets
   *
   * @throws SQLException
   */
  @Test
   ...
   * This com.zongze.test shows using a multi-property parameter.
   *
   * This com.zongze.test shows using annotations for stored procedures
   */
  @Test
   ...
   * This com.zongze.test shows using a single value parameter.
   *
   * This com.zongze.test shows using annotations for stored procedures and using a
   * resultMap in XML
   */
  @Test
  ...
  /*
   *
   * This com.zongze.test shows using a two named parameters.
   *
   * This com.zongze.test shows using annotations for stored procedures and using a
   * resultMap in XML
   */
   ...
   * This com.zongze.test shows how to call procedures that return multiple result sets
   *
   * This com.zongze.test shows using annotations for stored procedures and referring to
